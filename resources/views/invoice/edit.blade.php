...
@section('content-header', 'Invoice Edit')
@section('content-actions')
    <a href="" class="btn btn-primary">Invoice Edit</a>
@endsection
@section('style')
    <link rel="stylesheet" href="{{ asset('custom/css/pickadate/classic.css') }}">
    <link rel="stylesheet" href="{{ asset('custom/css/pickadate/classic.date.css') }}">
    @if(config('app.locale') == 'ar')
        <link rel="stylesheet" href="{{ asset('custom/css/pickadate/rtl.css') }}">
    @endif
    <style>
    ...
    <div class="row justify-content-center">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('invoice.update', $invoice->id) }}" method="post" class="form_sub">
                        @csrf
                        @method('PATCH')
                        <div class="row">
                            <div class="col-4">
...
@endsection
@section('script')
    <script src="{{ asset('custom/js/form_validation/jquery.form.js') }}"></script>
    <script src="{{ asset('custom/js/form_validation/jquery.validate.min.js') }}"></script>
    <script src="{{ asset('custom/js/form_validation/additional-methods.min.js') }}"></script>
    <script src="{{ asset('custom/js/pickadate/picker.js') }}"></script>
    <script src="{{ asset('custom/js/pickadate/picker.date.js') }}"></script>
    @if(config('app.locale') == 'ar')
        <script src="{{ asset('custom/js/form_validation/messages_ar.js') }}"></script>
        <script src="{{ asset('custom/js/pickadate/ar.js') }}"></script>
    @endif
